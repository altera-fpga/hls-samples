...
This design is meant to illustrate the IP component interface generated by register-mapped host pipes. For a more complete description of host pipe usages, each parameter and a list of properties, see the *[HLS IP Gen Handbook](https://docs.altera.com/r/docs/m615048/current/hls-ip-gen-handbook/11-pipes)*. Example usages can also be found in the [Pipes](/Tutorials/Features/experimental/pipes) and the [Streaming Data Interfaces](/Tutorials/Features/hls_flow_interfaces/streaming_data_interfaces) code sample.
